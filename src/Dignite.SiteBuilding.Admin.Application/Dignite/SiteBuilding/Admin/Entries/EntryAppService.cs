...
{
    public class EntryAppService : SiteBuildingAdminAppServiceBase, IEntryAppService
    {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        [Authorize(Permissions.SiteBuildingPermissions.Entry.Delete)]
        ...
        /// <returns></returns>
        [Authorize(Permissions.SiteBuildingPermissions.Entry.Audit)]
