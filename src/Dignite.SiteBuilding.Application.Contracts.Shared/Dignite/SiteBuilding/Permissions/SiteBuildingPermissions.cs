...
{
    public class SiteBuildingPermissions
    {
        public const string GroupName = "SiteBuilding";
        ...
        {
            return ReflectionHelper.GetPublicConstantsRecursively(typeof(SiteBuildingPermissions));
        }
    }
}