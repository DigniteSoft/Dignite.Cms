...
namespace Dignite.SiteBuilding
{
    public class ClientDemoService : ITransientDependency
    {
        ...
        public ClientDemoService(
            IPageAppService sampleAppService, 
        ...
        private async Task TestWithDynamicProxiesAsync()
        {
            ...
            Console.WriteLine("page item count: " + result.Items.Count);
        ...
        private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                var url = _configuration["RemoteServices:SiteBuilding:BaseUrl"] +
                          "api/SiteBuilding/sample/authorized";
